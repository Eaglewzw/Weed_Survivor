...
| 文档 | 内容 |
|------|------|
| [视频介绍脚本](./视频介绍脚本.md) | 3-5 分钟演示脚本，覆盖创作灵感、核心功能、技术亮点、应用前景 |
| [背景信息概况](./背景信息概况.md) | 项目定位、解决什么问题、为谁设计、市场价值、竞品对比 |
| [硬件清单](./硬件清单.md) | 完整 BOM、尺寸规格、硬件连接关系图 |
| [技术文档](./技术文档.md) | 开发环境配置、架构说明、问题排查，确保可复现 |
